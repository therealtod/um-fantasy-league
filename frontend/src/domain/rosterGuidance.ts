...
/**
 * Where a manager stands in the entry flow, and what the page should
...
/**
 * `standingsOpen` reaches only the `DONE` copy, and `SWAP` deliberately does
 * not consult it: a window opens between rounds of a LIVE tournament, so the
 * board is always there by then.
 */
